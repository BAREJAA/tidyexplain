...
anim_save(here::here("images", "sort_values-pandas.gif"), arrange_anim)
...
arrange_df_desc %>%
  ...
  scale_color_identity() +
  scale_size_identity() +
  ggtitle("df.sort_values(['colA'], ascending = False)") +
  theme_void() +
...
anim_save(here::here("images", "sort_values_desc-pandas.gif"), arrange_desc_anim)
